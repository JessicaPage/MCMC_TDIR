...
data_new = np.recfromtxt('chainfile_testing_fourier_domain_runtime.dat',names = True)
...
c.add_chain(data_plot, parameters=parameters,color=color.to_hex('green'),name='Fourier Domain Chain')
...
fig =c.plotter.plot(chains=['Fourier Domain Chain'],figsize=(7,7),filename='fourier_domian_results.png', truth=[0e1,0e1,0e1,0e1,0e1,0e1],display=True,legend=True)
print('ax')
print(fig.axes[6])
