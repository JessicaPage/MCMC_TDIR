...
def covariance_equal_arm():
	...
	#cov = np.array([[a,zero_array,zero_array],[zero_array,a,zero_array],[zero_array,zero_array,a]])
	return 2*a,2*b_
...
#sys.exit()
data =  np.genfromtxt(args.print_string[0],names=True)
...
number_chain = 100000
#number_chain  = 5000
checkfile = open(args.print_string[1],'w')
checkfile.write("#likelihood" + " " + "L_1" + " " + "L_1_p" + " " + "L_2" + " " + "L_2_p" + " " + "L_3" + " " + "L_3_p" + " " + "Current_AR" + "\n") 
k=1
...
old_likelihood = likelihood_analytical_equal_arm(x_combo_initial,y_combo_initial,z_combo_initial)
print('likelihood')
print(old_likelihood)
#sys.exit()
checkfile.write(str(old_likelihood) + " " + str(initial_L_1) + " " + str(initial_L_1_p) + " " + str(initial_L_2) + " " + str(initial_L_2_p)+ " " + str(initial_L_3) + " " + str(initial_L_3_p) + " " + str(accept/k) + "\n")
old_L_1 = initial_L_1
...
while k <= number_chain:
	...
	new_likelihood = likelihood_analytical_equal_arm(x_combo_old,y_combo_new,z_combo_new)
	...
	if alpha >= u:
		...
		accept+=1
		checkfile.write(str(old_likelihood) + " " + str(old_L_1) + " " + str(old_L_1_p) + " " + str(old_L_2) + " " + str(old_L_2_p) + " " + str(old_L_3) + " " + str(old_L_3_p) + " " + str(accept/k) + "\n")
	...
	new_likelihood = likelihood_analytical_equal_arm(x_combo_new,y_combo_old,z_combo_new)
	...
	new_likelihood = likelihood_analytical_equal_arm(x_combo_new,y_combo_new,z_combo_old)
