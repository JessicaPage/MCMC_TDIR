...
fig = c.plotter.plot(chains=['N=49','N=39','N=29','N=27','N=25','N=23','N=21','N=19'], figsize=(7,7),truth=[0e1,0e1,0e1,0e1,0e1,0e1],display=False,legend=True)


#For putting chi^2 plot in upper right corner
...
plt.xlabel('Filter Length N',fontsize=12)
plt.ylabel(r'median $\chi^{2}$',fontsize=12)
plt.xticks(fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('filter_length_tests_combined_test_resolution.png',dpi=300)
plt.show()
plt.close()
